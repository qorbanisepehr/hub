...
/**
 * Configurable Personal Info section shared across Cv, Employee, and
 * Questionnaire domains (ADR-007).
 *
 * The Employee and Questionnaire domains share the full applicant/employee
 * shape (including the national-card / birth-certificate / personnel-photo
 * document requirements and their static field-key labels); they differ only
 * in their label. The CV exposes a slimmer core that shares the shared rules
 * but overrides the field set, rules, storage, and drops the document
 * requirements.
 */
abstract class PersonalInfoSection extends BaseSection
{
    /**
     * @param  string  $labelKey  translation key, e.g. "questionnaire.sections.personal_info"
     */
