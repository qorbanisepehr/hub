...
description: "Use this skill when creating, modifying, or troubleshooting shadcn/ui components in React/Next.js projects. Trigger for: adding new components via CLI, customizing theme/colors/sizes, fixing component styling issues, understanding component APIs, creating form integrations, building data tables with TanStack, handling component composition patterns, or when the user asks about shadcn/ui configuration, component variants, or styling approaches. Covers all official shadcn/ui components including buttons, dialogs, forms, tables, cards, navigation elements, and data display components."
license: MIT
metadata:
  author: shadcn
---
