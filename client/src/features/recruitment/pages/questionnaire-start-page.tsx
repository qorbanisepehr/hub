...
export function QuestionnaireStartPage() {
    ...
    const mutation = useMutation({
        ...
        onSuccess: (response) => {
            ...
            navigate({ to: "/questionnaire/$uuid", params: { uuid: response.data.data.uuid } });
        },
        onError: (err) => {
            ...
            <div className="mx-auto max-w-2xl px-4 py-12">
                <div className="text-center mb-8">
                    ...
                    <p className="text-muted-foreground mt-2">
                        لطفاً اطلاعات زیر را تکمیل کنید تا فرم پرسشنامه برای شما ایجاد شود.
                    </p>
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        >
                            {mutation.error && (
                                <ErrorBanner message={getApiError(mutation.error) ?? "خطای ناشناخته"} />
                            )}

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <form.Field name="first_name">
                                    {(field) => (
                                        <FormTextField field={field} label="نام" />
                                    )}
                                </form.Field>
