...
import type { SubmitOptions } from "@/features/employees/validation";
...
export function buildEmployeeSubmitOptions(
    ...
    if (!formOptions || province === undefined || city === undefined) {
        return undefined;
    }
...
export function useEmployeeSubmitOptions() {
    return useFormOptionsWithPlaces(buildEmployeeSubmitOptions);
}
