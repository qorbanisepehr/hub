...
import { IconDashboard, IconIdBadge2, IconSettings, IconShield, IconUsers } from "@tabler/icons-react";
...
const items = [
    ...
    { title: "نقش‌ها", url: "/roles", icon: <IconShield />, permission: "role.view" as const },
